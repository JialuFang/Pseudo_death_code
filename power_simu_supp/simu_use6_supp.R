...
S_prog_fct2 <- function(t, t0=1/2){
  term1 <- 1 + 2*t
  term2 <- 2 + pmax(t+t0-2, 0)
  return(2 / (term1 * term2))
}
inv_S_prog_fct2 <- function(x, t0=1/2){
...
for (ii in 1:4){
  ...
  file.name <- paste0("./test_results/","Test_",samplesize,"_simu_use6_supp", ".Rdata")
